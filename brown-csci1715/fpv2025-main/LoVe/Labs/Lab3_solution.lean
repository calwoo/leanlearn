...
### 1.1. 
Supply structured proofs of the following theorems. -/
...
/- ### 1.2. 
\  Supply a structured proof of the contraposition rule. -/
...
/- ### 1.3. 
\  Supply a structured proof of the distributivity of `∀` over `∧`. -/
...
/- ### 1.4 (**optional**). 
\  Supply a structured proof of the following property, which can be used to pull a 
\  `∀` quantifier past an `∃` quantifier. -/
...
/- ### 2.2 (**optional**). 
\  Prove the same argument again, this time as a structured
